...
- Bug in comparisons between a :class:`SparseArray` and an array-like object retaining values equal to the result's fill value, which produced incorrect results when the comparison result was used as a boolean mask (:issue:`45284`)
